...
{	
	Properties	
	{
		 ...
		 _Color("Color", Color) = (1, 1, 1, 1) // color of the water
		 _EdgeColor("Edge Color", Color) = (1, 1, 1, 1) // color of the edge effect
		 _DepthFactor("Depth Factor", float) = 1.0 // width of the edge effect
	}
